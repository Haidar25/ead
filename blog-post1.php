...
<?php  include 'header.php'; ?>
  ...
  <div class="berita">
    <div class="container">
      <div class="news-feed">
        <div class="feed blog">
          <div class="newsg news2">
          </div>
          <div class="news-descg">
          <h1>Myanmar pun Berguru ke Kota Malang</h1>
          <span><i class="fa fa-user"></i>&nbsp;&nbsp;admin</span>
          <span><i class="fa fa-clock-o"></i>&nbsp;&nbsp;14 March 2016</span>
          <span><i class="fa fa-comments"></i>&nbsp;&nbsp;2 Comments</span>
          <p> Malang – Sebanyak lima orang perwakilan dari negara Myanmar berguru di Kota Malang sejak 1 Maret lalu. Dan direncanakan kegiatan transfer ilmu ini hingga tanggal 23 Maret mendatang. Kunjungan delegasi Myanmar yang dibalut dalam kegiatan pelatihan inipun dipusatkan di SMK Negeri 3 Malang.</p>
          </div>
         ...
         <h1>Comments</h1>
          	...
          	<h2>HAIDAR LAGI</h2>
          	<p>Waw itu sungguh mengejutkan ! saya sangat bangga sekali dengan kota Malang tercinta ini !
             tingkatkan terus prestasi mu Malang !</p>
          </div>
      </div>
