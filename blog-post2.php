...
<?php  include 'header.php'; ?>
  ...
  <div class="berita">
    <div class="container">
      <div class="news-feed">
        <div class="feed blog">
          <div class="newsg news3">
          </div>
          <div class="news-descg">
          <h1>SMK Negeri Diambil Alih Propinsi Siap Dimutasi Antar Daerah</h1>
          <span><i class="fa fa-user"></i>&nbsp;&nbsp;admin</span>
          <span><i class="fa fa-clock-o"></i>&nbsp;&nbsp;14 March 2016</span>
          <span><i class="fa fa-comments"></i>&nbsp;&nbsp;2 Comments</span>
          <p> Malang – Terhitung mulai bulan April 2016 mendatang, pengelolaan Sekolah Menengah Kejuruan Negeri (SMKN) pengelolaannya bakal diambil alih oleh pemerintah propinsi. Itu artinya Kepala Sekolah maupun tenaga pendidik harus siap dimutasi antar daerah yang ada di Jawa Timur. </p>
          </div>
         ...
         <h1>Comments</h1>
          	...
          	<h2>LAGI LAGI HAIDAR</h2>
          	<p>Ini lah kota Malang, karena malang santai Sayang.. 
                keep support Arema lah yang penting wkwk .</p>
          </div>
      </div>
