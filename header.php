  ...
  <div class="menu2">
  	<div class="container">
          ...
          <li><a href="#">LAYANAN</a>
              <ul>
                 <li><a style="font-size:14px" href="pengaduan_masyarakat.php">Pengaduan Masyarakat</a> 
                 <a style="font-size:14px" href="pengajuan_npsn.php">Pengajuan NPSP</a>
                 <a style="font-size:14px" href="ijin_operasional.php">Ijin Operasional</a>
        			   <a style="font-size:14px" href="mutasi_siswa.php">Mutasi Siswa</a>
                  </li>
              </ul>
          </li>
