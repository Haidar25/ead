  ...
  <div class="menu2">
  	<div class="container">
  		...
  		<a href="#footer_nav" onclick="toggleNav(); return false;"><div class="menu_button"></div></a>
    		...
    		<ul>
                <li><span class="bold"><a href="index.php?page=pengaduan">PENGADUAN MASYARAKAT</a></span></li>
                <li><span class="bold"><a href="index.php?page=pengajuan">PENGAJUAN NPSN</a></span></li>
                <li><span class="bold"><a href="index.php?page=ijin">IJIN OPERASIONAL</a></span></li>
                <li><span class="bold"><a href="index.php?page=mutasi">MUTASI MURID</a></span></li>
    			<li><span class="bold"><a href="../system/logout.php">LOGOUT</a></span></li>
    		</ul>
